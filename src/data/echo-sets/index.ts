...
import windwardPilgrimageRaw from "./raw/windward-pilgrimage.json"
...
const windwardPilgrimage = {
  ...windwardPilgrimageRaw,
  type: windwardPilgrimageRaw.type as "two-five",
  buffs: [
    {
