...
export function findWeaponByName(name: string): WeaponData | null {
...
export function listWeapons(): WeaponData[] {
  return ALL_WEAPONS
}
...
export function listWeaponsByType(weaponType: string): WeaponData[] {
